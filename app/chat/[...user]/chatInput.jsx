        ...
        <>
            ...
            <div className='chatInput_cont px-3 pt-2 pb-4'>
                <div className='d-flex justify-content-between align-items-center'>
                    {audioUrl == null && <form action="" className='position-relative'>
                        <textarea value={text} onChange={(e)=> setText(e.target.value)} type="text" className='py-3 rounded-pill pe-3' placeholder='Type message ...' />
                    ...
                    <div ref={audioBRef} className='audio ms-2 d-flex justify-content-center align-items-center' onClick={(text.length > 0 && !recording && audioUrl == null && !sending) ? sendMessage: (!(text.length > 0) && !recording && audioUrl == null && !sending) ? voiceRecord: (recording && audioUrl == nul && !sending) ? stopRecording : sendRecord}>
