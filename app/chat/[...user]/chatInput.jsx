        ...
        <>
            ...
            <div className='chatInput_cont px-3 pt-2 pb-4'>
                <div className='d-flex justify-content-between align-items-center'>
                    ...
                    <div ref={audioBRef} className='audio ms-2 d-flex justify-content-center align-items-center' onClick={(text.length > 0 && !recording && audioUrl == null) ? sendMessage: (!(text.length > 0) && !recording && audioUrl == null) ? voiceRecord: (recording && audioUrl == null) ? stopRecording : sendRecord}>
